...
public class FOV {
	...
	*/
	void scanNW2N(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope){
	...
	/* scanNE2N
		...
		been applied in FOV::start
	*/
	void scanNE2N(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope){
		if(distance > maxRadius)
		{
			return;
		}
	...
	/* scanNW2W
		...
		been applied in FOV::start
	*/
	void scanNW2W(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
	...
	/* scanSW2W
		...
		been applied in FOV::start
	*/
	void scanSW2W(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
	...
	/* scanSW2S
		...
		been applied in FOV::start
	*/
	void scanSW2S(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
	...
	/* scanSE2S
		...
		been applied in FOV::start
	*/
	void scanSE2S(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
	...
	/* scanNE2E
		...
		been applied in FOV::start
	*/
	void scanNE2E(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
	...
	/* scanSE2E
		...
		been applied in FOV::start
	*/
	void scanSE2E(FOVMap map, int xCenter, int yCenter, int distance, int maxRadius, double startSlope, double endSlope)
	{
		if(distance > maxRadius)
		{
			return;
