...
public class Prelude5 extends Unleasher {
	public void unleash(Level level, Game game) {
		...
		UserInterface.getUI().drawEffect(EffectFactory.getSingleton().createLocatedEffect(level.getPlayer().getPosition(), "SFX_MORPH_SOLIEYU"));
