...
public class GirdLevelGenerator extends LevelGenerator {
	...
	public Level generateLevel(Position size, int startIndex, int endIndex, int roomWidth, int roomHeight, boolean horizontal) throws CRLException{
		...
		if (horizontal){
			entrancePosition = new Position(0, roomHeight * startIndex + roomHeight / 2);
			exitPosition = new Position(cells[0].length-1,roomHeight * endIndex + roomHeight / 2);
		} else {
			entrancePosition = new Position(roomWidth * startIndex + roomWidth / 2, 0);
			exitPosition = new Position(roomWidth * endIndex + roomWidth / 2, cells[0][0].length-1);
		}
