...
public class GFXCuts {
		...
		PRT_F1, PRT_F2, PRT_F3, PRT_F4, PRT_F5, PRT_F6;
	{
		try {
			...
			PRT_CLAW = ImageUtils.crearImagen(PRT, 8, 303, 84, 86);
			PRT_CLARA = ImageUtils.crearImagen(PRT, 98, 303, 84, 86);
			PRT_MELDUCK = ImageUtils.crearImagen(PRT, 188, 303, 84, 86);
			PRT_MAIDEN = ImageUtils.crearImagen(PRT, 278, 303, 84, 86);
	...
	private Hashtable hashCuts = new Hashtable();
	{
		...
		temp = new GFXChat();
		temp.add("Melduck", "This looks bad... with the charriot like this we cannot make it to Petra, and this creepy forest...", PRT_MELDUCK);
		...
		temp.add("???", "Leave this castle now if you want to live... this is not a place for commoners like you", PRT_CLAW);
		temp.add("%NAME", "%%CLARA1");
		temp.add("???", "Oh really? You don't have a clue about anything... this castle is a creature of chaos, and it will engulf you mercilessly", PRT_CLAW);
		...
		temp.add("Death", "I admire your attitude, but I am afraid THAT won't be enough... how dare you challenge the Castle of Chaos mortal!", PRT_DEATH);
		...
		temp.add("Sorceress?", "Forgive me for what I am about to do, but you must understand... I am sure they will understand", PRT_VINDELITH);
		...
		temp.add("Vindelith", "I hope you realize what you are doing now, the time is running out and you are just slowing us down!", PRT_VINDELITH);
		...
		temp = new GFXChat();
		temp.add("Short haired girl", "What a nasty surprise... another annoying bug comes to stop our advancement", PRT_CLARA);
		temp.add("%NAME", "I am not sure I know what you mean");
		temp.add("Vindelith", "I saw this person back when Claw beat me up, perhaps they are a team", PRT_VINDELITH);
		temp.add("Short haired girl", "Claw... I am tired of hearing that name! Your friend has been a nuisance for us for too long!", PRT_CLARA);
		...
		temp.add("Short haired girl", "Belmont? So, you too are claiming to belong to the Belmont Heritage? That means we have a problem here!", PRT_CLARA);
		temp.add("Vindelith", "Clara! We can't afford to lose any more time fiddling with scumbags like this... let's push ahead!", PRT_VINDELITH);
