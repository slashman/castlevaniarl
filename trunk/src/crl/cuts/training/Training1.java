...
public class Training1 extends Unleasher {
	public void unleash(Level level, Game game){
		...
		Display.thus.showScreen("Use the numerical pad or directional keys to move, 'L' to look at the different sign posts, '?' for help. Press 'Q' to exit this training.");
