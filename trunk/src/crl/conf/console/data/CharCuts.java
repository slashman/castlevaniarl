...
public class CharCuts {
	...
	private Hashtable hashCuts = new Hashtable();
	{
		...
		temp.add("Count Dracula", "HAHAHAHA! Don't make me laugh, pitiful excuse for a warrior, you shall regret your words!");
		hashCuts.put("PRELUDE_DRACULA1", temp);
		temp = new CharChat();
		temp.add("Soleiyu Belmont", "Father! I finally understand, I am here to confront my destiny, the destiny marked by my legacy!");
		...
		temp.add("Soleiyu Belmont", "What! What is this! What happens to my body! ARGH!");
		...
		// Intro Sequence
		temp = new CharChat();
		temp.add("Melduck", "No luck, with the charriot like this we cannot make it to Petra, and this creepy forest...");
		...
		temp = new CharChat();
		temp.add("Mysterious Girl", "What is this... another fool going into the castle... Who are you?");
		temp.add("%NAME", "My name is %NAME");
		temp.add("Mysterious Girl", "Leave this castle now if you want to live... this is not a place for commoners like you!");
		temp.add("%NAME", "%%CLARA1");
		/*
		 * This can be any of the following:
		 * {Player_VK}: I came here to fulfill my fate as a Vampire Killer, and destroy the dark count Dracula
		 * {Player_VA}: Get out of my way, I have issues to attend inside the castle
		 * {Player_RE}: Commonner? . . . Ignorant human... get out of my way.
		 ...
		 */
		temp.add("Mysterious Girl", "Oh really? You don't have a clue about anything... this castle is a creature of chaos, and it will engulf you mercilessly.");
		temp.add("Mysterious Girl", "Goodbye fool, maybe we will meet inside... if you survive!");
		...
		temp.add("Death", "I admire your attitude, but I am afraid THAT won't be enough... how dare you challenge the Castle of Chaos mortal!");
		temp.add("Death", "I would stop you here if I wanted to, but that would be much of a swift death for one that dares to challenge this castle! You will die as your brothers, and your soul will haunt this place for eternity!"); 
		...
		temp.add("Mysterious Woman", "You have come pretty far on the castle; this place is safe for you, for now.");
		temp.add("%NAME", "But... who are ---");
		temp.add("Mysterious Woman", "I am known as Heliann, the blacksmith maiden. I inhabit the villa of Castlevania, I am here to help the Belmonts to find their path."); 
		...
		temp = new CharChat();
		temp.add("Count Dracula", "It is worthless! As long as light exists on this world, I shall return as darkness made flesh!");
		...
		temp.add("Soleiyu Belmont", "It is all worthless, all our efforts... A world of light is a dream built up by dreamers, for dreamers.");
		...
		temp.add("Sorceress?", "Give up now foolish girl! There is no place for your games in this place. Leave now, we do not need you!");
		temp.add("Mysterious Girl", "I will not give up, NEVER!");
		temp.add("Sorceress?", "Then we have a problem, and I only see one way to fix it!");
		temp.add("Sorceress?", "Forgive me for what I am about to do, but you must understand... I am sure they will understand");
		temp.add("Mysterious Girl", "I am tired of your words... now fall to my claws!");
		hashCuts.put("VINDELITH1", temp);
		temp = new CharChat();
		temp.add("Sorceress?", "Girl you are strong... stronger than I thought... you have forced me to stay here for now.");
		temp.add("Mysterious Girl", "Now don't blame me Vindelith... you asked for this");
		temp.add("Vindelith", "I hope you realize what you are doing now, the time is running out and you are just slowing us down!");
		...
		// Girls Sequence 2
		temp = new CharChat();
		temp.add("Short haired girl", "What a surprise... another annoying bug comes to stop our advancement");
		...
		temp.add("Short haired girl", "Claw... I am tired of hearing that name! Your friend has been a nuisance for us for too long!");
		...
		temp.add("Short haired girl", "Belmont? So, you too are claiming to belong to the Belmont Heritage? That means we have a problem here!");
		temp.add("Vindelith", "Clara! We can't afford to lose any more time fiddling with scumbags like this... let's push ahead!");
		temp.add("Clara", "You are right... I have seen enough fake Belmonts lately... Just a word of advice \"Belmont\": get the hell out of here while you can!");
